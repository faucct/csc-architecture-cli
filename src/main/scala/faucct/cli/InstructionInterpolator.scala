...
import faucct.cli.commands.{AssignmentCommand, CatCommand, CdCommand, EchoCommand, ExitCommand, ExternalCommand, GrepCommand, NoopCommand, PipeCommand, PwdCommand, WcCommand}
